...
# 点击搜索
serach = driver.until(lambda x:x.find_element_by_xpath("//*[contains(@content-desc, '搜索')]"))
serach.click()
# 输入搜索内容
serach_text = driver.until(lambda x : x.find_element_by_id("android:id/search_src_text"))
